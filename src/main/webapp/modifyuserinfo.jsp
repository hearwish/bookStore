            ...
            <td>
                <div style="text-align:right; margin:5px 10px 5px 0px">
                    <a href="index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
                        href="${pageContext.request.contextPath}/findUserById?id=${loginUser.id}">&nbsp;我的帐户</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;用户信息修改
                </div>
                ...
                <table cellspacing="0" class="infocontent">
                    <tr>
                        <td>
                            <form action="${pageContext.request.contextPath}/modifyUserInfo?id=${loginUser.id}" method="post">
                                ...
                                <table width="100%" border="0" cellspacing="2" class="upline">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="password" class="textinput" name="checkPassword"/>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="2">&nbsp;&nbsp;
                                            <input type="radio" name="gender"
                                                   value="男" ${u.gender == '男' ? 'checked="checked"' : ''} /> 男
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" name="gender"
